...
export function PageHeader({
  ...
  return (
    <section className="relative isolate min-h-[25rem] overflow-hidden bg-ink text-ink-foreground">
      {image && (
        <>
          <img
            src={image}
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
        ...
        <h1 className="mt-6 max-w-3xl text-4xl font-bold leading-[1.05] sm:text-5xl lg:text-6xl">{title}</h1>
